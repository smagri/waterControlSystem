...
// Foreach new widget class used include the header file.
...
// Foreach new widget class used include class instance.
class QwtPlotGrid; // compiler error: 'QwtPlotGrid' does not name a
		   // type' occurrs otherwise.
class QwtPlotCurve;
class QwtPlotMarker;
class QwtSymbol;
