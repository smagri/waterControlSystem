...
void TankLevel::updatePlotLevel(){
  ...
  // static double t1 = 30.0;
  // static double t2 = 40.0;
  // static double t3 = 60.0;
  // static double h1 = 90.0;
  // static double h2 = 80.0;
  // static double h3 = 70.0;
  ...
  plotCurve->setSamples(time, height, sizeof(time));
...
//  QString levelValueStr;
  ...
  ui->labelAbsLevel->setText((const char*) &charRead);
...
void TankLevel::updatePercentageLevel(){
  ...
  ui->labelPercentLevel->setText((const char*) &charRead);
